...
- (void)connection:(NSURLConnection*)connection didReceiveData:(NSData*)data
{
	...
	float progress = (float)[responseData length]/(float)[self.response expectedContentLength];
	NSNumber * progressNum = [NSNumber numberWithFloat:progress];
	[target performSelector:@selector(fileDownloadHasProgressedBy:) withObject:progressNum];
}
